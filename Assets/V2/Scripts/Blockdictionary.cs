...
{
    public string name;
    public int height; // altura del tile (0,1,2…)
}
...
public class Blockdictionary : ScriptableObject
{
    ...
    public int tilesPerRow = 128;
    public int tilesPerColumn = 128;
    ...
    int totalRelations = codes.Length;
    struct Pattern
    {
        public byte mask;
        public byte value;
